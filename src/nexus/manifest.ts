...
export const CAPABILITY_MANIFEST: CapabilitySpec[] = [
  // ------------------------------------------------------------------ Firefox (web)
  {
    ...
    substrate: "firefox",
    name: "Map semantic app controls",
    role: "region",
    axId: "nexus.graph",
    location: "loaded application graph",
    readiness: "live-demo",
    blurb: "Discover app structure by role, name, state, and provenance rather than pixels.",
  },
  {
    capabilityId: "read_current_theme",
    substrate: "firefox",
    name: "Read current appearance theme",
    role: "region",
    axId: "settings.theme",
    location: "/index.html",
    readiness: "live-demo",
    blurb: "Read fresh page state through the engine-owned BiDi session.",
  },
  {
    ...
    location: "/index.html",
    readiness: "live-demo",
    blurb: "Resolve a graph capability, invoke it through the safety engine, then verify live state.",
  },
  {
    capabilityId: "extract_design_tokens",
    substrate: "firefox",
    name: "Extract W3C design tokens",
    role: "region",
    axId: "settings.tokens",
    location: "loaded application graph",
    readiness: "live-demo",
    blurb: "Export the crawled design system as structured W3C DTCG data.",
  },
  {
    capabilityId: "open_sensitive_dialog",
    substrate: "firefox",
    name: "Open sensitive account dialog",
    role: "button",
    tier: "CONFIRM",
    axId: "safety.dialog",
    location: "/index.html",
    readiness: "live-demo",
    blurb: "The engine blocks a sensitive graph capability until the user explicitly approves.",
  },
  {
    ...
    readiness: "roadmap",
    blurb: "Modeled in the offline world; billing keywords force CONFIRM before execution.",
  },
  {
